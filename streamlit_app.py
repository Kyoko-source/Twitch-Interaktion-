...
# =========================
    ...
    function weaponSfx(k,n=1){sfx(k,n);try{if(k==="explode"){tone(96,.18,"sawtooth",.075);tone(52,.22,"sine",.05,.025);noise(.26,.07,.01)}if(k==="laserHit"){tone(1320,.035,"sine",.045);tone(1780,.045,"triangle",.032,.018)}if(k==="freeze"){tone(420,.08,"sine",.035);tone(1180,.12,"triangle",.024,.025);noise(.08,.014)}if(k==="orbitHit"){tone(620,.026,"triangle",.018);tone(920,.03,"sine",.014,.012)}}catch(e){}}
